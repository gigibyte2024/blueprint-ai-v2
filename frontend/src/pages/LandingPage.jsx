      ...
      <section className="max-w-6xl mx-auto px-8 py-24">
        ...
        <div className="text-center">
          ...
          <h1 className="text-6xl md:text-7xl font-extrabold text-white leading-tight">
            ...
            <br />
            Into a
            <span className="text-violet-500"> Complete Blueprint</span>
          </h1>

          <p className="text-slate-400 text-xl mt-8 max-w-3xl mx-auto leading-9">
            Generate product planning, technical architecture,
            database schema, APIs and UI design in seconds using AI.
          </p>
